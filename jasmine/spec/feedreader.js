...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('Each object has an URL and that the URL is not empty.', function() {
         ...
         */
        it('Each object has an name and that the name is not empty.', function() {
    ...
    describe("The menu", function() {
        ...
        it("is visible when the menu icon is clicked and hidden when when clicked again", function() {
         ...
         $( ".feed" ).empty();
            ...
            it('content actually changes', function(done) {
               window.loadFeed(1, function() {
                   endingState = $('.feed').html();
                   expect(endingState !== originalState).toBeTruthy();
                   done();
               });
            });
       });
